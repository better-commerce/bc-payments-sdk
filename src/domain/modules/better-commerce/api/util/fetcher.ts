...
import axios from "../../../../../infrastructure/core/api"
import { BCEnvironment } from "../../../../config/BCEnvironment"
import { APIException, AuthenticationException, InvalidRequestException } from "../../../../entity";
...
const fetcher = async ({ url = '', method = 'post', data = {}, params = {}, headers = {}, cookies = {}, baseUrl = "", }: any) => {
    ...
    const newConfig = {
        ...
        CompanyId: cookies?.CompanyId && cookies?.CompanyId != Defaults.Guid.Value
            ? cookies?.CompanyId
            : Defaults.Guid.Value,
