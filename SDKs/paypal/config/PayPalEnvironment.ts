 ...
 * @static
 */
export default class PayPalEnvironment {
    ...
    static init(clientId: string, appSecret: string, useSandBox = true) {
        ...
        if (useSandBox) {
            PayPalEnvironment.baseUrl = SDKs.Paypal.Domain.Constants.Endpoints.Base.SANDBOX_URL;
        } else {
            PayPalEnvironment.baseUrl = SDKs.Paypal.Domain.Constants.Endpoints.Base.PRODUCTION_URL;
        }
        return this;
    }
